...
export function ProjectDetailPageV2() {
  ...
  const filteredGlobalResources = globalResources.filter((resource) => resource.resource_type === activeTab);
  ...
  return (
    <PageShell className="gap-5">
      ...
      <ToolbarRow>
        ...
        />
        {activeTab !== 'mcp_server' && activeTab !== 'settings' && activeTab !== 'files' ? (
      ...
      <PanelSection>
        {activeTab === 'files' ? (
          ...
          project ? <SettingsEditor project={project} /> : null
