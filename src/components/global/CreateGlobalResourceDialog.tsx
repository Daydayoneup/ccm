...
interface CreateGlobalResourceDialogProps {
  onSubmit: (resourceType: ResourceType, name: string, content: string) => Promise<unknown>;
  defaultType?: ResourceType;
}

export function CreateGlobalResourceDialog({ onSubmit, defaultType }: CreateGlobalResourceDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await onSubmit(resourceType, name.trim(), content);
      setName('');
      setContent('');
      setOpen(false);
    } catch (e) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Create Global Resource</DialogTitle>
        </DialogHeader>
